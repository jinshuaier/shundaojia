...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _imgView.frame = CGRectMake(16, 13, 22, 22);
        [self.contentView addSubview:_imgView];
        
        _titLa=[[UILabel alloc]init];
        _titLa.frame = CGRectMake(CGRectGetMaxX(_imgView.frame) + 8, 15, 56, 18);
        [self.contentView addSubview:_titLa];
        _titLa.textColor = TCUIColorFromRGB(0xFFFFFF);
        _titLa.font = [UIFont fontWithName:@"PingFangSC-Medium" size:14];
...
-(instancetype)initWithTitles:(NSArray *)titles icons:(NSArray *)icons menuWidth:(CGFloat)itemWidth delegate:(id<LSXPopMenuDelegate>)delegate{
    ...
    if(self=[super init]){
        ...
        _isShowTriangle=YES;
        _fontSize = 15.0;
        _textColor = TCUIColorFromRGB(0xFFFFFF);
        _offset = 0.0;
...
//        _separatorColor = [UIColor lightGrayColor];
        ...
        _lArrowPosition = itemWidth - 10 - 12;
...
//        _mainView.alpha = 0.1;
        ...
        _contentView.backgroundColor = TCUIColorFromRGB(0x000000);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titLa.textColor=TCUIColorFromRGB(0xFFFFFF);
    cell.titLa.alpha = 1;
    cell.titLa.font=[UIFont fontWithName:@"PingFangSC-Medium" size:14];
    cell.cellHeight = 48;
    cell.Model=DataArr[indexPath.row];
    cell.backgroundColor = TCUIColorFromRGB(0x000000);
    cell.alpha = 0.6;
