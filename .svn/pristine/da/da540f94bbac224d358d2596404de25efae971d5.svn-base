...
@interface TCaddBankVerViewController ()<UITextFieldDelegate>
...
@implementation TCaddBankVerViewController
...
-(void)clickyan:(UIButton *)sender{
    NSLog(@"验证信息");
    TCextanceAddVController *extanceAdd = [[TCextanceAddVController alloc]init];
    [self.navigationController pushViewController:extanceAdd animated:YES];
}
