...
@interface TCNewPassViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCNewPassViewController
...
-(void)clickSure:(UIButton *)sender{
    TCagainNewPassViewController *agaSetpay = [[TCagainNewPassViewController alloc]init];
    agaSetpay.titleStr = self.titleStr;
    agaSetpay.onePass = self.nePass;
    agaSetpay.sms = self.smss;
    agaSetpay.entranceTypeStr = self.entranceTypeStr;
