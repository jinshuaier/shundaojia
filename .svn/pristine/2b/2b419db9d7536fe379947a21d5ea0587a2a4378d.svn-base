...
#import "TCReseagainController.h"
#define PWD_COUNT 6
#define DOT_WIDTH 10
@interface TCReseNewViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCReseNewViewController
...
-(void)clickSure:(UIButton *)sender{
    TCReseagainController *reseagain = [[TCReseagainController alloc]init];
    [self.navigationController pushViewController:reseagain animated:YES];
