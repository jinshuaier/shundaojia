...
#import "TCBinNewpassViewController.h"
#import "TCBinagainViewController.h"
#define PWD_COUNT 6
#define DOT_WIDTH 10
@interface TCBinNewpassViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCBinNewpassViewController
...
-(void)creatUI{
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(12, 48 + StatusBarAndNavigationBarHeight, 160, 20)];
    label.text = @"请输入6位密码";
...
-(void)clickSure:(UIButton *)sender{
    TCBinagainViewController *binagain = [[TCBinagainViewController alloc]init];
    [self.navigationController pushViewController:binagain animated:YES];
