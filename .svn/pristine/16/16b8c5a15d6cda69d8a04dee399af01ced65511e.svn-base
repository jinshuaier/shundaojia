...
@interface TCFirstinputCardController ()<UITextFieldDelegate>
@property (nonatomic, strong) UIButton *nextBtn;

@end

@implementation TCFirstinputCardController
...
-(void)clickNext:(UIButton *)sender{
    TCAddBankCardViewController *addBank = [[TCAddBankCardViewController alloc]init];
