...
#define PWD_COUNT 6
#define DOT_WIDTH 10
@interface TCFistinputPassController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCFistinputPassController
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (totalString.length == 6) {
        ...
        TCFirstinputCardController *inputVC = [[TCFirstinputCardController alloc]init];
