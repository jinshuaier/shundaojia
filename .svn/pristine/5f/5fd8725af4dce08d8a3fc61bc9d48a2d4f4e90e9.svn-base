...
#define PWD_COUNT 6
#define DOT_WIDTH 10
@interface TCBindingPassViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCBindingPassViewController
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    if (totalString.length == 6) {
        ...
        TCBindingCardViewController *inputVC = [[TCBindingCardViewController alloc]init];
