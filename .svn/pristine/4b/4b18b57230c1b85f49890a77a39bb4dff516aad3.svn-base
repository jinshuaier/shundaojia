...
@interface TCFirstVerViewController ()<UITextFieldDelegate>
...
@implementation TCFirstVerViewController
...
-(void)clickSure:(UIButton *)sender{
    NSLog(@"点击确认");
    TCPayVerViewController *payVer = [[TCPayVerViewController alloc]init];
    [self.navigationController pushViewController:payVer animated:YES];
