...
@interface TCBindingNoSetController ()<UITextFieldDelegate>
...
@implementation TCBindingNoSetController
...
-(void)clickyan:(UIButton *)sender{
    NSLog(@"验证信息");
    TCBinNewpassViewController *newPass = [[TCBinNewpassViewController alloc]init];
