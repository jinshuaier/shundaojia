...
#import "TCagainSetViewController.h"
#define PWD_COUNT 6
#define DOT_WIDTH 10
@interface TCSetPassViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCSetPassViewController
...
-(void)clickSure:(UIButton *)sender{
    TCagainSetViewController *againVC = [[TCagainSetViewController alloc]init];
