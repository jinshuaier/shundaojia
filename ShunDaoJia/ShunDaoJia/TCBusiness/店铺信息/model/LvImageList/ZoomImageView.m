...
//        UIImageView *iamges = [[UIImageView alloc] init];
//        iamges.image = self.image;
//        [iamges sd_setImageWithURL:[NSURL URLWithString:self.nowImage] placeholderImage:[UIImage imageNamed:@"商品详情页占位"]];
        
        self.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:imageStr]]];
