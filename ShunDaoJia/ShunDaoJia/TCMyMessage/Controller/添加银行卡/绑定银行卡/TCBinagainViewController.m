...
#import "TCBindingCardViewController.h"
#define PWD_COUNT 6
#define DOT_WIDTH 10
@interface TCBinagainViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCBinagainViewController
...
-(void)clickSure:(UIButton *)sender{
    TCBindingCardViewController *Card = [[TCBindingCardViewController alloc]init];
