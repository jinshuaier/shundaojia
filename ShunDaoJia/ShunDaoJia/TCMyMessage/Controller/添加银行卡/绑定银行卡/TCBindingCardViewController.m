...
@interface TCBindingCardViewController ()<UITextFieldDelegate>
@property (nonatomic, strong) UIButton *nextBtn;

@end

@implementation TCBindingCardViewController
...
-(void)clickNext:(UIButton *)sender{
    TCBindingDetialViewController *detail = [[TCBindingDetialViewController alloc]init];
