...
@interface TCResePhoneViewController ()<UITextFieldDelegate>
...
@implementation TCResePhoneViewController
...
UIView *verficationView = [[UIView alloc]initWithFrame:CGRectMake(12 , 12 + StatusBarAndNavigationBarHeight , 220, 40)];
...
UIButton *verBtn = [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMaxX(verficationView.frame) + 12, 12 + StatusBarAndNavigationBarHeight, WIDTH - 220 - 36, 40)];
verBtn.tag = 1000;
