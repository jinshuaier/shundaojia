...
#import "TCFirstinputCardController.h"


#define PWD_COUNT 6
#define DOT_WIDTH 10

@interface TCagainsetPayViewController ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation TCagainsetPayViewController
...
-(void)clickSure:(UIButton *)sender{
    ...
    TCFirstinputCardController *addVC = [[TCFirstinputCardController alloc]init];
