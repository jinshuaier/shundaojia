...
#import "TCCardaddViewController.h"
#import "TCaddBankVerViewController.h"
#import "TCProtocolViewController.h"

@interface TCCardaddViewController ()<UITextFieldDelegate>
@property (nonatomic, strong) UIButton *checkBtn;

@end

@implementation TCCardaddViewController
...
-(void)clickSure:(UIButton *)sender{
    NSLog(@"点击了验证");
    TCaddBankVerViewController *addBankVer = [[TCaddBankVerViewController alloc]init];
    [self.navigationController pushViewController:addBankVer animated:YES];
}
