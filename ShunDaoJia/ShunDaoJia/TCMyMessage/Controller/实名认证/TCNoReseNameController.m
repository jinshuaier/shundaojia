...
#import "TCNoReseNameController.h"
#import "TCCardaddViewController.h"

@interface TCNoReseNameController ()<UITextFieldDelegate>
@property (nonatomic, strong) UIButton *nextBtn;

@end

@implementation TCNoReseNameController
...
-(void)clickNext:(UIButton *)sender{
    TCCardaddViewController *cardAdd = [[TCCardaddViewController alloc]init];
    [self.navigationController pushViewController:cardAdd animated:YES];
